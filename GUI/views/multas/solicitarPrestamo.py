...
def prestamo():
    ...
    y3 = Label(y2, text="SOLICITAR PRESTAMO",bg='black', fg='white', width=25,font=("bold", 22))
    y3.place(x=40, y=60)
    ...
    def callback():
        try:
            res = funciones.realizarPrestamo(b1.get(),c1.get())
            if(res["status"]==1):
            ...
            showerror("Arquitectura empresarial",  "Ocurrio un error al realizar el prestamo")
